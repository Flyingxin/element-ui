...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/carousel/src/item.vue?vue&type=template&id=539d1cb1&
var render = function () {
  var _vm = this
  ...
  return _c(
    "div",
    {
      ...
      class: {
        ...
        "el-carousel__item--rotate": _vm.$parent.type === "rotate",
        "is-in-stage": _vm.inStage,
        "is-hover": _vm.hover,
        "is-animating": _vm.animating,
        "is-backface": _vm.backface,
      },
      style: _vm.itemStyle,
      on: { click: _vm.handleItemClick },
    },
    [
      _vm.$parent.type === "card" || "rotate"
        ? _c("div", {
            directives: [
              {
                name: "show",
...
// CONCATENATED MODULE: ./packages/carousel/src/item.vue?vue&type=template&id=539d1cb1&
...
/* harmony default export */ var itemvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    //  计算转动后 z轴的偏移量
    calcRotateTranslate: function calcRotateTranslate() {
      var parentWidth = this.$parent.$el.offsetWidth;
      ...
      switch (length) {
        ...
        case 5:
          return parentWidth * 0.6882; // 内切圆半径
        case 6:
  ...
  computed: {
    ...
    itemStyle: function itemStyle() {
      ...
      if (parentType === 'rotate') {
        var rotateType = this.parentDirection === 'vertical' ? 'rotateX' : 'rotateY';
        var value = rotateType + '(' + this.rotate + 'deg) translateZ(' + this.translate + 'px)';
        style = { transform: value };
      } else {
        var translateType = this.parentDirection === 'vertical' ? 'translateY' : 'translateX';
        var _value = translateType + '(' + this.translate + 'px) scale(' + this.scale + ')';
        style = { transform: _value };
      }
      return Object(util_["autoprefixer"])(style); //  兼容浏览器autoprefixer
    }
  },
  //  更新所有item
